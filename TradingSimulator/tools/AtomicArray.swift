...
extension AtomicArray {
    ...
    @discardableResult
    mutating func remove(at i: AtomicArray.Index) -> AtomicArray.Element {
        _wait(); defer { _signal() }
    ...
    @discardableResult
    mutating func removeFirst() -> AtomicArray.Element {
        _wait(); defer { _signal() }
    ...
    @discardableResult
    mutating func removeLast() -> AtomicArray.Element {
        _wait(); defer { _signal() }
